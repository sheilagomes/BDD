...
E('preencho os campos do formulário com dados válidos de pessoa física') do
...
Dado("eu preencha os campos com {string},{string},{string},{string},{string},{string}") do |nome, sobrenome, email,
celular, tipo_de_conta, documento |
